    ...
    <body>
        ...
        <section>
            <div class="container text-center">
                <h2 class="text-uppercase pt-5 pb-3">Our Bank Category Database Management System</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <p class="text-center text-capitalize mt-1">
                                ...
                                and you can avail customized insurance schemes to stay financially secure. 
                        </p>
                    </div>
                    <div class="row pt-4">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <p class="text-center text-capitalize mt-1">
                                ...
                                No matter why you need a personal loan, HDFC Bank can customize the offering for you. If you already have an HDFC Bank account, you can benefit from special rates, 
